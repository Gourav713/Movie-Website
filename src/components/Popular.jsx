...
function Popular() {
  ...
  const getPopular = async (resetData = false) => {
    if (loading) return;
    try {
      setLoading(true);
      setError(null);
    ...
    <div className="min-h-screen min-w-screen bg-gray-900">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                <div className="flex items-center gap-2">
                  <i className="ri-bard-fill text-purple-500 text-2xl"></i>
            ...
            <div className="text-center py-8">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-gray-800 rounded-lg">
                ...
                <span className="text-gray-300">
                  You've seen all {popular.length} popular items!
                </span>
              </div>
            </div>
          }
          ...
          <div className="mt-8 text-center">
            <div className="inline-flex items-center gap-4 px-6 py-3 bg-gray-800/50 rounded-full">
              <div className="flex items-center gap-2 text-sm text-gray-400">
                ...
                <span>
                  Showing {popular.length} of {totalResults.toLocaleString()}
                </span>
              </div>
      ...
      {popular.length > 20 && (
        <button
          ...
          className="fixed bottom-6 right-6 p-3 bg-purple-500 hover:bg-purple-600 text-white rounded-full shadow-lg transition-all duration-200 z-40"
          title="Scroll to Top"
        >
